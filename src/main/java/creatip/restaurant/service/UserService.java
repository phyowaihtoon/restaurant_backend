...
import creatip.restaurant.repository.UserRoleRepository;
import creatip.restaurant.security.RandomUtil;
...
public class UserService {
    ...
    public User registerUser(AdminUserDTO userDTO, String password) {
        ...
        userRoleRepository.findOneByName(UserRoleConstants.USER).ifPresent(userRoles::add);
    ...
    public User createUser(AdminUserDTO userDTO) {
        ...
        if (userDTO.getAuthorities() != null) {
            Set<UserRole> authorities = userDTO
                .getAuthorities()
                .stream()
                .map(userRoleRepository::findOneByName)
    ...
    public Optional<AdminUserDTO> updateUser(AdminUserDTO userDTO) {
        return Optional.of(userRepository.findById(userDTO.getId()))
            ...
            .map(user -> {
                ...
                user.setLangKey(userDTO.getLangKey());
                Set<UserRole> managedAuthorities = user.getRoles();
    ...
    public List<String> getAuthorities() {
        return userRoleRepository.findAll().stream().map(UserRole::getName).toList();
    }
}
